package org.copticchurchlibrary.arabicreader.fragment;
...
import org.copticchurchlibrary.arabicreader.MainActivity;
import org.copticchurchlibrary.arabicreader.R;
import org.copticchurchlibrary.arabicreader.adapter.DetailPlaylistAdapter;
import org.copticchurchlibrary.arabicreader.adapter.DetailPlaylistAdapter.IDetailPlaylistAdapterListener;
import org.copticchurchlibrary.arabicreader.adapter.PlaylistAdapter;
import org.copticchurchlibrary.arabicreader.adapter.PlaylistAdapter.OnPlaylistListener;
...
public class FragmentPlaylist extends DBFragment implements IMyMusicPlayerConstants {
	...
	public void findView() {
		...
		boolean isBg=USE_BACKGROUND;
		if(isBg){
			this.mListViewPlaylist.setDivider(new ColorDrawable(mContext.getResources().getColor(R.color.black_deviders)));
			this.mListViewDetailPlaylist.setDivider(new ColorDrawable(mContext.getResources().getColor(R.color.black_deviders)));
			this.mListViewPlaylist.setDividerHeight(mContext.getResources().getDimensionPixelOffset(R.dimen.devider));
			this.mListViewDetailPlaylist.setDividerHeight(mContext.getResources().getDimensionPixelOffset(R.dimen.devider));
		}
		else{
			this.mListViewPlaylist.setDivider(new ColorDrawable(Color.TRANSPARENT));
			this.mListViewDetailPlaylist.setDivider(new ColorDrawable(Color.TRANSPARENT));
	...
	private void setUpHeaderForPlaylist() {
		...
		boolean isBg=USE_BACKGROUND;
		mHeaderPlaylistView.setBackgroundColor(isBg?Color.TRANSPARENT:Color.WHITE);
	...
	private void setUpHeaderForDetailPlaylist() {
		...
		boolean isBg=USE_BACKGROUND;
		mHeaderDetailPlaylistView.setBackgroundColor(isBg?Color.TRANSPARENT:Color.WHITE);
