...
import org.copticchurchlibrary.arabicreader.adapter.LibraryAdapter;
import org.copticchurchlibrary.arabicreader.adapter.LibraryAdapter.OnLibraryListener;
...
public class FragmentHome extends DBFragment implements IMyMusicPlayerConstants{
	...
	public void findView() {
		...
		if(isBg){
			this.mListView.setDivider(new ColorDrawable(mContext.getResources().getColor(R.color.black_deviders)));
			this.mListView.setDividerHeight(mContext.getResources().getDimensionPixelOffset(R.dimen.devider));
		}
		else{
			this.mListView.setDivider(new ColorDrawable(Color.TRANSPARENT));
			this.mListView.setDividerHeight(mContext.getResources().getDimensionPixelOffset(R.dimen.devider));
		}
