package org.copticchurchlibrary.arabicreader.constants;
...
public interface IMyMusicPlayerConstants {
	...
	public static final boolean USE_BACKGROUND = true;//if you want to use background , let change it to be true
	...
	public static final String URL_YOUR_WEBSITE = "http://arabicreader.copticchurch-library.org/";
	public static final String URL_YOUR_FACE_BOOK = "https://www.facebook.com/ArabicReader/";
	...
	public static final String NAME_FOLDER_LIBRARY = "musicplayer";
