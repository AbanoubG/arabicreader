...
public class PresetAdapter extends ArrayAdapter<String>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(org.copticchurchlibrary.arabicreader.R.layout.item_preset_name, null);
			convertView.setTag(mHolder);
		}
		else {
			mHolder = (ViewHolder) convertView.getTag();
		}
		mHolder.mTvName =(TextView) convertView.findViewById(org.copticchurchlibrary.arabicreader.R.id.tv_name);
